...
| Tải nhạc | Tách album (chống trùng) | Thư viện |
|---|---|---|
| ![Tab tải nhạc](screenshots/01-download.png) | ![Tách album Spotify](screenshots/02-spotify-album.png) | ![Thư viện](screenshots/03-library.png) |
...
- App **chỉ chạy cục bộ** (lắng nghe `127.0.0.1`, không có đăng nhập). **Đừng** mở cổng này ra Internet.
- Hãy **tôn trọng bản quyền**: chỉ tải nội dung bạn có quyền, dùng cho mục đích cá nhân. Bạn tự chịu trách nhiệm khi sử dụng.
